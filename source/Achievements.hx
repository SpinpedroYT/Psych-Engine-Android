...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["No Furries!",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["We lost because of you!",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
		["Tight Bars",			"Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			false],
		["Insane Rapper!",					"Beat Week 4 on Hard with no Misses.",				'week4_nomiss',			false],
		["Cute Hedgehogs",			"Beat Week 5 on Hard with no Misses.",				'week5_nomiss',			false],
		["FAKE ARTIC FOX!!",					"Beat Week 6 on Hard with no Misses.",				'week6_nomiss',			false],
		["Damn BF AR AR AR",		"Beat Week 7 on Hard with no Misses.",				'week7_nomiss',			 true],
		["I fell bad for you",	"Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
		["Flippy is that you?",				"Complete a Song with a rating of 100%.",			'ur_good',				false],
		["WHY?!",			"Watch the dancers die over 100 times.",			'roadkill_enthusiast',	false],
		["You ok...?",		"Hold down a note for 20 seconds.",					'oversinging',			false],
		["Hyperactive",					"Finish a Song without going Idle.",				'hype',					false],
		["Just the Two of Us",			"Finish a Song pressing only two keys.",			'two_keys',				false],
		["Gama Baja Gamer",				"Have you tried to run the game on a toaster?",		'toastie',				false],
		["Motherfucker!",					"Beat the \"Test\" Stage from the Chart Editor.",	'debugger',				 true]
	];
